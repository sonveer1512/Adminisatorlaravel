                    ...
                    <div class="row align-items-center justify-content-between g-3 mb-3">
                        ...
                        <div class="col-auto">
                            <div class="d-flex align-items-center"><button
                                    class="btn btn-link text-900 me-4 px-0"><button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#verticallyCentered"><span class="fas fa-plus me-2"></span>Add Brand</button></div>
                        </div>
                    </div>
                    <div
