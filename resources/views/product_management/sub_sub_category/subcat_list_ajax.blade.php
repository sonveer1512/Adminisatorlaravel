                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-end">
                                                                ...
                                                                <a class="dropdown-item" data-bs-target="#deletepopup" data-bs-toggle="modal" onclick="deletepopup('{{ $value->id }}','sub_sub_catrgory','activate')" style="color:green;">Active</a>
                                                                    @elseif($value->flag == 0)
                                                                    <a class="dropdown-item" data-bs-target="#sub_sub_Categorymodel" data-bs-toggle="modal" onclick="sub_subcategory_edit('{{ $value->id }}','{{$id}}',{{$value->category_id}})" style="color:blue;">Edit</a>
                ...
                <form class="row g-3" id="subsubcategoryadd" method="POST">
                    ...
                    <div class="col-md-6">
                        <div class="form-floating mb-2 mt-2">
                            <input class="form-control" id="subcateid" type="hidden" name="subcateid" value="{{$id}}" readonly/>
                    ...
                    <div class="col-md-6">
                        <div class="form-floating mb-2 mt-2">
                            <input class="form-control" id="category_id" type="hidden" name="category_id" value="{{$cat_name->id}}" readonly/>
