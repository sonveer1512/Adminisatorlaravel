                                        ...
                                        <div class="card task-box  bg-border_{{$value->id}} background_{{$value->id}} card_body_cat" style="@if($value->flag == 0) border: 1px solid #cec4c4; @elseif($value->flag == 1) border: 1px solid red; @else border:1px solid #cec4c4 @endif">
                                            <div class="card-body">
                                                <div class="d-flex align-items-start">
                                                    <div class="flex-grow-1" onclick="sub_sub_category_list({{$value->id}},{{$value->flag}})">
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-end">
                                                                ...
                                                                @elseif($value->flag == 0)  
                                                                        ...
                                                                        <a class="dropdown-item" data-bs-target="#subCategorymodel" data-bs-toggle="modal" onclick="subcategory_edit('{{ $value->id }}','{{$id}}')" style="color:blue;">Edit</a>
                ...
                <form class="row g-3" id="subcategoryadd" method="POST">
                    ...
                    <div class="col-md-4">
                        <div class="form-floating mb-2 mt-2">
                            ...
                            <input class="form-control" id="cate_id" type="hidden" name="cate_id" value="{{$id}}" readonly/>
