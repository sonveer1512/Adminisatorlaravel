...
Route::group(['middleware' => 'auth'], function() {
    ...
    Route::prefix('distributor/')->group(function () {
        ...
        Route::post('changepass', [DistributorController::class, 'changepass']);
        Route::post('change_pass_update', [DistributorController::class, 'change_pass_update']);
    });
    ...
    Route::prefix('vendor/')->group(function () {
        ...
        Route::post('changepass', [VendorControler::class, 'changepass']);
        Route::post('change_pass_update', [VendorControler::class, 'change_pass_update']);
    });
